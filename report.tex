...
Our code implementation solves this problem, and the algorithm is as follows: 
1) For the start call ( Start ), find the next peak time start or end time ( 7:00 or 18:59 ) and save it as T1;
2) Next, find the last start( Last ) or end time that is before the end call and save it as T2;
Next, if the 
