...
period 7:00 -> 18:59, a call from 20:30 till 21:30 would be correctly charged for $60 minutes \ast
...
2) Next, find the last start or end time ( LAST ) that is before the end call and save it as T2;
The case when START and LAST times are in the same peak or off-peak period is the trivial one and we compute the 
cost for the call as $(LAST - START) \ast ( on-peak OR off-peak ) tariff$. More 
